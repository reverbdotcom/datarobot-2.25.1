    ...
    _converter = t.Dict(
        {
            ...
            t.Key("secondary_datasets"): t.List(_secondary_dataset_converter),
            t.Key("name", optional=True): t.String | t.Null,
            t.Key("creator_full_name", optional=True): t.String(),
            t.Key("creator_user_id", optional=True): t.String(),
            t.Key("created", optional=True): parse_time,
            t.Key("featurelist_id", optional=True): t.String | t.Null,
            t.Key("credential_ids", optional=True): t.List(_stored_credentials),
            t.Key("is_default", optional=True): t.Bool,
            t.Key("project_version", optional=True): t.String | t.Null,
        }
    ).ignore_extra("*")
